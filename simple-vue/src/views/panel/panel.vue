    ...
    <div class="filter-container">
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        ...
        <el-form-item label="库号">
          <el-select v-model="listQuery.database" placeholder="库号">
...
<script>
  export default {
    ...
    methods: {
      ...
      exportData() {
        this.formInline.database = this.listQuery.database;
        this.formInline.keyword = this.listQuery.keyword;
        this.formInline.excelName = this.listQuery.excelName;
