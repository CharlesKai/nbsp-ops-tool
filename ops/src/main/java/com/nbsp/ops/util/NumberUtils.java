...
public class NumberUtils {
  ...
  /**
   * <code>NumberUtils</code> instances should NOT be constructed in standard programming. Instead,
   * the class should be used as <code>NumberUtils.toInt("6");</code>.
   *
   ...
   * conversion fails.
   *
   * <p>If the string <code>str</code> is <code>null</code>, <code>0.0f</code> is returned.
   *
   * <pre>
   ...
   * conversion fails.
   *
   * <p>If the string <code>str</code> is <code>null</code>, the default value is returned.
   *
   * <pre>
   ...
   * conversion fails.
   *
   * <p>If the string <code>str</code> is <code>null</code>, <code>0.0d</code> is returned.
   *
   * <pre>
   ...
   *
   * <p>Returns <code>true</code> if s is <code>null</code>.
   *
   ...
   *
   * <p>If any value is <code>NaN</code>, <code>NaN</code> is returned. Infinity is handled.
   *
   * @param a value 1
   * @param b value 2
   * @param c value 3
   ...
   *
   * <p><code>Null</code> and empty String will return <code>false</code>.
   *
   ...
   *
   * <p>Valid numbers include hexadecimal marked with the <code>0x</code> qualifier, scientific
