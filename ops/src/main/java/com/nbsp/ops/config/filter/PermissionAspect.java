package com.nbsp.ops.config.filter;

import com.nbsp.ops.config.annotation.Logical;
import com.nbsp.ops.config.annotation.RequiresPermissions;
import com.nbsp.ops.config.exception.UnauthorizedException;
import com.nbsp.ops.dto.session.SessionUserInfo;
import com.nbsp.ops.service.TokenService;
...
public class PermissionAspect {
    ...
    @Before("@annotation(com.nbsp.ops.config.annotation.RequiresPermissions)")
