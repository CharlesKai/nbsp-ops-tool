...
import com.nbsp.ops.config.exception.CommonJsonException;
import com.nbsp.ops.dao.LoginDao;
...
public class TokenService {
  ...
  @Autowired Cache<String, SessionUserInfo> cacheMap;
  ...
  /** 根据token查询用户信息 如果token无效,会抛未登录的异常 */
